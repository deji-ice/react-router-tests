    ...
    <div className="h-screen bg-yellow-300 pt-20">
      ...
      <div className=" px-20 pl-[28rem]">
        <p className="pr-5 leading-relaxed text-lg">
          <b>Lorem ipsum</b> dolor sit amet, consectetur adipisicing elit. <b>Animi</b> ipsa
          cupiditate excepturi tempore quo quae repellendus nam modi, id fugit
          molestiae numquam velit commodi porro voluptas exercitationem in nobis
          error quia quas similique voluptatibus.
